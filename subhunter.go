...
func InitializeFingerprints() {
	...
	if _, err := os.Stat(filePath); os.IsNotExist(err) {
		...
		if err := downloadFile(filePath, "https://raw.githubusercontent.com/umutcamliyurt/Subhunter/main/fingerprint.json"); err != nil {
...
func main() {
	...
	fmt.Println("Created by umutcamliyurt")
